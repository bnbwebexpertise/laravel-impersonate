...
namespace Bnb\Laravel\Impersonate;
...
use Bnb\Laravel\Impersonate\Guard\SessionGuard;
use Bnb\Laravel\Impersonate\Middleware\ProtectFromImpersonation;
use Bnb\Laravel\Impersonate\Services\ImpersonateManager;

/**
 * Class ServiceProvider
 *
 * @package Bnb\Laravel\Impersonate
 */
    ...
    protected function registerRoutesMacro()
    {
        ...
        $router->macro('impersonate', function () use ($router) {
            $router->get('/impersonate/take/{id}/{guardName?}',
                '\Bnb\Laravel\Impersonate\Controllers\ImpersonateController@take')->name('impersonate');
            $router->get('/impersonate/leave',
                '\Bnb\Laravel\Impersonate\Controllers\ImpersonateController@leave')->name('impersonate.leave');
        });
    }
