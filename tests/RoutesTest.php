...
class RoutesTest extends TestCase
{
    ...
    function it_adds_impersonate_route()
    {
        ...
        $this->assertTrue((bool)$this->routes->getByAction('Bnb\Laravel\Impersonate\Controllers\ImpersonateController@take'));
    }
    ...
    function it_adds_leave_route()
    {
        ...
        $this->assertTrue((bool)$this->routes->getByAction('Bnb\Laravel\Impersonate\Controllers\ImpersonateController@leave'));
    }
}
